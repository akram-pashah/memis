...
{
  public class ActivityAssessmentDto
  {
    ...
    [Display(Name = "Actual")]
    public int? QActual { get; set; }

    [Display(Name = "AmtSpent")]
    public int? QAmtSpent { get; set; }

    [Display(Name = "Achievement")]
    public int? QAchievement { get; set; }
    
    [Display(Name = "Justification")]
    public int? QJustification { get; set; }
