...
{ 
    public class HerbalInspectionDto
    {
        [Key]
        ...
        [Display(Name = "Activity Carried Out")]
        public int Activity { get; set; }

        [Display(Name = "Recommendation for Herbal Certification")]
        public int CertRecommendation { get; set; }
