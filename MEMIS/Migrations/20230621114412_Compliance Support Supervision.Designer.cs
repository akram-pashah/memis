...
namespace MEMIS.Migrations
{
    ...
    [Migration("20230621114412_Compliance Support Supervision")]
    partial class ComplianceSupportSupervision
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MEMIS.Data.ActivityPlan", b =>
                {
                    ...
                    b.Property<int?>("ProjectInitiatinId")
                        .IsRequired()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MEMIS.Data.ProjectInitiatin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MEMIS.Data.ProjectRistIdentification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectRistIdentification");
                });
            ...
            modelBuilder.Entity("MEMIS.Data.ActivityPlan", b =>
                {
                    b.HasOne("MEMIS.Data.ProjectInitiatin", "ProjectInitiatinFk")
                        .WithMany()
                        .HasForeignKey("ProjectInitiatinId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProjectInitiatinFk");
                });
            ...
            modelBuilder.Entity("MEMIS.Data.Department", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Hod")
                        .WithMany()
                        .HasForeignKey("HodId");
