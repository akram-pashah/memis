...
{
    public partial class RelocationDrugShop : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "RelocationDrugShop",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelocationDrugShop", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RelocationDrugShop_District_DistrictId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelocationDrugShop_DistrictId",
                table: "RelocationDrugShop",
                column: "DistrictId");
        }
