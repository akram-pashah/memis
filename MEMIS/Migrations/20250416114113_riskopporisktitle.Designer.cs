...
namespace MEMIS.Migrations
{
    ...
    [Migration("20250416114113_riskopporisktitle")]
    partial class riskopporisktitle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MEMIS.Data.ComplianceSupportSupervision", b =>
                {
                    ...
                    b.Property<string>("Other_CategoryPremise")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("UnRegDrugQty")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("UnRegisteredDrug")
                        .HasColumnType("int");

                    b.Property<int?>("Unlicensed")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MEMIS.Data.PostMarketSurveillance", b =>
                {
                    ...
                    b.ToTable("PostMarketSurveillance");
                });
            ...
            modelBuilder.Entity("MEMIS.Data.Project.ProjectSubmittalTracker", b =>
                {
                    ...
                    b.Property<string>("SubmittalDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MEMIS.Data.Risk.RiskAdditionalMitigation", b =>
                {
                    b.Property<int>("AdditionalMitigationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdditionalMitigationId"));
                    ...
                    b.HasKey("AdditionalMitigationId");

                    b.HasIndex("RiskId");

                    b.ToTable("RiskAdditionalMitigations");
                });
            ...
            modelBuilder.Entity("MEMIS.Data.Risk.RiskExistMitigation", b =>
                {
                    b.Property<int>("ExistMitigationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExistMitigationId"));
                    ...
                    b.HasKey("ExistMitigationId");

                    b.HasIndex("RiskId");

                    b.ToTable("RiskExistMitigations");
                });
            ...
            modelBuilder.Entity("MEMIS.Data.Risk.RiskRegister", b =>
                {
                    ...
                    b.Property<double?>("IncidentImpact")
                        .HasColumnType("float");

                    b.Property<double?>("OperationGovernanceImpact")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MEMIS.Data.Risk.RiskTreatmentPlan", b =>
                {
                    ...
                    b.Property<string>("FrequencyOfOccurrence")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MEMIS.Data.ProjectRiskIdentification", b =>
                {
                    b.HasOne("MEMIS.Data.ProjectInitiation", "ProjectInitiationFk")
                        .WithMany("ProjectRiskIdentifications")
                        .HasForeignKey("ProjectInitiationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
