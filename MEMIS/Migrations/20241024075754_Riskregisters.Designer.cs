...
namespace MEMIS.Migrations
{
    ...
    [Migration("20241024075754_Riskregisters")]
    partial class Riskregisters
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MEMIS.Data.Risk.Incident", b =>
                {
                    ...
                    b.Property<int?>("RiskRegisterRiskRefID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RiskRegisterRiskRefID");
            ...
            modelBuilder.Entity("MEMIS.Data.Risk.Incident", b =>
                {
                    ...
                    b.HasOne("MEMIS.Data.Risk.RiskRegister", null)
                        .WithMany("Incidents")
                        .HasForeignKey("RiskRegisterRiskRefID");
