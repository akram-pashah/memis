...
{
    public partial class PrijectInitiation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicAction = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Renewal_District_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "District",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Renewal_Region_intRegion",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Renewal_DistrictId",
                table: "Renewal",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_Renewal_intRegion",
                table: "Renewal",
                column: "intRegion");
        }
