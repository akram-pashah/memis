...
namespace MEMIS.Migrations
{
    ...
    [Migration("20240115050219_ndp_hd_2")]
    partial class ndp_hd_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MEMIS.Data.Planning.FocusArea", b =>
                {
                    b.Property<int>("intFocusArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("intFocusArea"), 1L, 1);
                    ...
                    b.HasKey("intFocusArea");

                    b.ToTable("T_FOCUSAREA");
                });

            modelBuilder.Entity("MEMIS.Data.Planning.ImplementationPlan", b =>
                {
                    b.Property<int>("intActivity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("T_IMPLEMENTATIONPLAN");
                });

            modelBuilder.Entity("MEMIS.Data.Planning.StrategicObjective", b =>
                {
                    b.Property<int>("intStrategicObjective")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("intStrategicObjective"), 1L, 1);

                    b.Property<string>("StrategicObjectiveCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StrategicObjectiveName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("intStrategicObjective");

                    b.ToTable("T_STRATEGICOBJECTIVE");
                });
            ...
            modelBuilder.Entity("MEMIS.Data.Risk.RiskIdent", b =>
                {
                    b.HasOne("MEMIS.Data.Planning.StrategicObjective", "StrategicObjectiveFk")
                        .WithMany()
