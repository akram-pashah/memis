  ...
  public class SDTMastersController : Controller
  {
    ...
    public async Task<IActionResult> Edit(int? id)
    {
      ...
      SDTMastersCreateEditDto dto = new SDTMastersCreateEditDto
      {
        ...
        Id = sDTMaster.Id,
        ServiceDeliveryTimeline = sDTMaster.ServiceDeliveryTimeline,
        PropotionWithinTimeline= sDTMaster.PropotionWithinTimeline,
        Target = sDTMaster.Target
      };
      ViewData["DepartmentId"] = new SelectList(_context.Departments, "intDept", "deptName", sDTMaster.DepartmentId);
      return View(dto);
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Id,ServiceDeliveryTimeline,Measure,EvaluationPeriod,Target,Numerator,Denominator,DepartmentId,PropotionWithinTimeline")] SDTMastersCreateEditDto sDTMaster)
    {
      if (id != sDTMaster.Id)
      {
        return NotFound();
