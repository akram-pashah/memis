...
namespace MEMIS.Controllers
{
  public class StrategicActionsController : Controller
  {
    ...
    public async Task<IActionResult> Create([Bind("intAction,actionCode,actionName,intIntervention")] StrategicAction strategicAction)
    {
      ...
      ViewData["intIntervention"] = new SelectList(_context.StrategicIntervention.Select(o => new { o.intIntervention, DisplayText = o.InterventionCode + " - " + o.InterventionName }), "intIntervention", "DisplayText", strategicAction.intIntervention);
      return View(strategicAction);
    }
